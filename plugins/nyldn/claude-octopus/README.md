...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Version-9.66.1-blue" alt="Version 9.66.1">
...
> 🆕 **v9.66.1 — Declare OpenClaw tool contracts and make benchmark-gated council tests deterministic.**
>
...
|---------|--------------|
| **v9.66.1** (new) | Declare OpenClaw tool contracts and make benchmark-gated council tests deterministic. |
